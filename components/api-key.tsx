...
export default function ApiKey() {
  ...
  // const userPlan = 'Free';
  // const userPlanLimit = 1000;
  // const userPlanLimitUsed = 125;
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          <div className="bg-white rounded-md p-4 shadow-lg">
            ...
            <div className="font-medium text-1xl mb-2 flex items-center">
              ...
              <span className="ml-4 text-2xl">API Key</span>
            ...
            <div className="sm:hidden mb-2 flex items-center">
              ...
              <button onClick={() => handleCopy()}>
                <svg className="ml-4" width="36px" height="36px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12ZM16 7H11C10.4239 7 10 7.42386 10 8V10H8C7.42386 10 7 10.4239 7 11V16C7 16.5761 7.42386 17 8 17H13C13.5761 17 14 16.5761 14 16V14H16C16.5761 14 17 13.5761 17 13V8C17 7.42386 16.5761 7 16 7ZM8 11H10V13C10 13.5761 10.4239 14 11 14H13V16H8V11ZM11 13V8H16V13H11Z" fill="#8EE8C9"/>
                </svg>
              </button>
            </div>
            ...
            {/* Mobile & Desktop */}
            <div className="text-gray-600 mb-2 flex items-center mt-8">
              Your API key grants you access to the Trvium API. You must pass the key in your request headers when calling the API.
              {/* Desktop */}
              <button className="hidden sm:inline ml-8 px-4 py-2 rounded-md bg-purple-300 text-white hover:bg-purple-400">Generate</button>
            </div>

            {/* Mobile */}
            <button className="sm:hidden mt-4 px-4 py-2 rounded-md bg-purple-300 text-white hover:bg-purple-400">Generate</button>
