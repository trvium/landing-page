        ...
        <div className="py-12 md:py-20 border-t border-gray-200">
          ...
          <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-200 rounded-lg shadow-lg p-8" data-aos="fade-up" data-aos-delay="0">
              ...
              <a className="bg-gray-400 text-white py-2 px-6 rounded-full hover:bg-gray-300 transition duration-150 ease-in-out" href="/signup">Choose Plan</a>
            </div>
            ...
            <div className="bg-gray-200 rounded-lg shadow-lg p-8" data-aos="fade-up" data-aos-delay="100">
              ...
              <a className="bg-[#5D5DFF] text-white py-2 px-6 rounded-full hover:bg-[#38379C] transition duration-150 ease-in-out" href="/signup">Choose Plan</a>
            </div>
