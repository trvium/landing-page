  ...
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-500">

          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Don't take our word for it</h2>
            <p className="text-xl text-gray-300">Vitae aliquet nec ullamcorper sit amet risus nullam eget felis semper quis lectus nulla at volutpat diam ut venenatis tellus—in ornare.</p>
          </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-500" data-aos="fade-up">
              <div>
                <div className="relative inline-flex flex-col mb-4">
                  ...
                  <svg className="absolute top-0 right-0 -mr-3 w-6 h-5 fill-current text-purple-500" viewBox="0 0 24 20" xmlns="http://www.w3.org/2000/svg">
