      ...
      >
        <ul className="bg-[#D9D9D9] px-4 py-2">
          ...
          <li>
            <Link
              href="/signup"
              className="font-medium w-full inline-flex items-center justify-center border border-transparent px-3 py-2 my-2 rounded-md text-white bg-[#FF8C00] hover:bg-[#FFA500] transition duration-150 ease-in-out" onClick={() => setMobileNavOpen(false)}
            >
              Sign up
            </Link>
          </li>
